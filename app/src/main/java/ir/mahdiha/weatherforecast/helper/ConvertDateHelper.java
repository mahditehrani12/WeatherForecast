...
public class ConvertDateHelper
{
    ...
    private class SolarCalendar
    {
        ...
        public static String getCurrentShamsidate()
        {
            ...
            ConvertDateHelper convertDateHelper = new ConvertDateHelper();
            SolarCalendar sc = convertDateHelper.new SolarCalendar();
            return String.valueOf(sc.year) + "/" + String.format(loc, "%02d",
                    sc.month) + "/" + String.format(loc, "%02d", sc.date);
        }

    public static String getCurrentShamsidate(String date)
    {
        Locale loc = new Locale("en_US");
        ConvertDateHelper convertDateHelper = new ConvertDateHelper();
        SolarCalendar sc = convertDateHelper.new SolarCalendar(date);
        Log.i("PRS", "month is="+sc.month);
        return String.valueOf(sc.year) + "/" + String.format(loc, "%02d",
                sc.month) + "/" + String.format(loc, "%02d", sc.date);
    }
